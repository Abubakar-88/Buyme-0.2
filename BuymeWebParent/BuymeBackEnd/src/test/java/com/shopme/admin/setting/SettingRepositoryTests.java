...
public class SettingRepositoryTests {
	...
	public void testCreateGeneralSettings() {
		Setting siteName = new Setting("SITE_NAME", "Buyme", SettingCategory.GENERAL);
		Setting siteLogo = new Setting("SITE_LOGO", "Buyme.png", SettingCategory.GENERAL);
		Setting copyright = new Setting("COPYRIGHT", "Copyright (C) 2021 Buyme Ltd.", SettingCategory.GENERAL);
