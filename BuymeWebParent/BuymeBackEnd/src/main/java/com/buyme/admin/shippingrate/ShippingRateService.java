...
import com.buyme.admin.setting.country.CountryRepository;
...
public class ShippingRateService {
	...
	public Long getTotalShippingRate() {
		return shipRepo.count();
	}
	public Long getTotalShippingRateCodes() {
		Iterable<ShippingRate> shippingRates = shipRepo.findAll();
		Stream<ShippingRate> shippingRateStream = StreamSupport.stream(shippingRates.spliterator(), false);
		return shippingRateStream
				.map(ShippingRate::isCodSupported)
				.distinct()
				.count();
	}
}
